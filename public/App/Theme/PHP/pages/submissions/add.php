...
<!-- /.progressbar -->
<form method="post" action="javascript:void(0)" class="submission-form form-vertical">
<div class="row">
<div class="span4">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" name="post_title" size="30" value="" id="address" autocomplete="off" required="required">
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <textarea id="description" rows="10" name="content" required="required"></textarea>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select name='property_types' id='property_types' class='postform'>
                ...
                <option class="level-0" value="41">Family House</option>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select name='property_locations' id='property_locations' class='postform'>
                ...
                <option class="level-0" value="52">Sursum Corda</option>
        ...
        <div class="controls">
            <ul class="unstyled">
                ...
                <li id='amenities-25'><label class="selectit"><input value="25" type="checkbox"
                                                                     name="tax_input[amenities][]"
                                                                     id="in-amenities-25"/> Iron</label></li>
                ...
                <li id='amenities-27'><label class="selectit"><input value="27" type="checkbox"
                                                                     name="tax_input[amenities][]"
                                                                     id="in-amenities-27"/> Lift</label></li>
                ...
                <li id='amenities-31'><label class="selectit"><input value="31" type="checkbox"
                                                                     name="tax_input[amenities][]"
                                                                     id="in-amenities-31"/> Parquet</label></li>
                ...
                <li id='amenities-33'><label class="selectit"><input value="33" type="checkbox"
                                                                     name="tax_input[amenities][]"
                                                                     id="in-amenities-33"/> Roof terrace</label></li>
                ...
                <li id='amenities-38'><label class="selectit"><input value="38" type="checkbox"
                                                                     name="tax_input[amenities][]"
                                                                     id="in-amenities-38"/> Use of pool</label></li>
...
<div class="span4">
    <div class="control-group">
        ...
        <div class="controls">
            <div class="input-append">
                <input type="number" name="_property_meta[price]" value="">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="number" name="_property_meta[bathrooms]" value="">
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="number" name="_property_meta[bedrooms]" value="">
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <div class="input-append">
                <input type="number" name="_property_meta[area]" value="">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="latitude" type="text" name="_property_meta[latitude]" value="" placeholder="Latitude"/>

            <input class="longitude" type="text" name="_property_meta[longitude]" value="" placeholder="Longitude"/>
        </div>
    </div>
